      ...
      personas: [
        {
          ...
          edad: 19,
          descripcion: "Estudiante de Derecho y activista",
          ...
          logros: ["Representante estudiantil 2023", "Secretaria de Comunicaciones ANDES"],
        ...
        },
        {
          ...
          nombre: "Jhexy Toncón",
          edad: 18,
          descripcion: "Líderesa comunitaria y activista.",
          ...
          logros: ["Voluntaria en organizaciones locales", "Promotora de la participación juvenil"],
          propuestas: ["Ampliar programas sociales juveniles", "Crear redes de apoyo comunitario", "Impulsar la educación popular"],
          quote: "Solo en comunidad podemos construir un futuro más justo."
        },
        {
          id: 3,
          nombre: "Fabián Márquez",
          edad: 17,
          descripcion: "Programador revolucionario y activista.",
          ...
          logros: ["Mentor en programación juvenil", "Organizador de hackathons sociales", "Vulnerar la seguridad de cxeducativa"],
          propuestas: ["Democratizar el acceso a la información", "Crear plataformas digitales participativas", "Servicio Social para La Paz"],
          quote: "La información es poder. Pero como todo poder, hay quienes quieren quedárselo solo para ellos."
        },
      ],
    },
    {
      ...
      personas: [
        {
          ...
          nombre: "Luz Mariana",
          edad: 16,
          descripcion: "Joven líder secundarista.",
          ...
          logros: ["Líder de campaña 'Agua para todos'", "Reconocimiento ambiental juvenil 2023"],
        ...
        },
        {
          ...
          edad: 15,
          descripcion: "Activista y feminista.",
          ...
          logros: ["Organizadora de festival cultural", "Capacitada en derechos humanos"],
        ...
        },
        {
          ...
          edad: 16,
          descripcion: "Estudiante de secundaria apasionado por la cultura y el deporte.",
          descripcionLarga: "Estudiante destacado que combina su pasión por el estudio con el deporte como herramienta de transformación social.",
          img: "/candidatos/pelao.webp",
          instagram: "juancito",
          especialidad: "Cultura y Deporte",
          logros: ["Campeón intercolegiado 2023", "Entrenador voluntario juvenil"],
          propuestas: ["Impulsar el deporte popular", "Fomentar la innovación juvenil"],
          quote: "La educación y el deporte son herramientas poderosas para construir una sociedad mejor."
        },
      ],
    },
  ];
